      ...
      <div className="min-h-0 overflow-y-auto p-5">
        ...
        {selected ? <>
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            ...
            {selected.actionUrl?.startsWith("/") && !selected.actionUrl.startsWith("//") && <button type="button" onClick={() => onNavigate(selected.actionUrl!)} className="rounded-md border border-primary/50 px-3 py-2 font-mono text-xs text-primary" data-testid="button-open-notification-context">Open related page</button>}
