...
- [Scoped upload authorization](scoped-upload-authorization.md) — authorize scoped URL claims and never infer legacy path provenance from live references alone.
