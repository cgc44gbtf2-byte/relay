/*
 * Frozen schema fixture for the reviewed migration rehearsal.
 *
 * This intentionally represents the database shape immediately before the
 * first reviewed migration. Do not update it to match the current schema
 * unless the migration baseline is intentionally replaced and reviewed.
 */
import {
  boolean,
  integer,
...
export const rolePermissionsTable = pgTable(
  "irc_role_permissions",
  {
    ...
    permissionId: integer("permission_id")
      .notNull()
      .references(() => permissionDefinitionsTable.id, { onDelete: "cascade" }),
  },
